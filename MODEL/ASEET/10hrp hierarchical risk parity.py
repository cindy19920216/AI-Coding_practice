...
# Define output directory at the top of the script
output_dir = os.path.abspath("C:/mnt/nas/Class/2026/asset_pricing").replace("\\", os.sep)
...
prices = yf.download(tickers, start="2019-01-01", end=None, auto_adjust=True)["Close"]
...
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "10_hrp_hierarchical_risk_parity.png"), dpi=150, bbox_inches="tight")
plt.show()
